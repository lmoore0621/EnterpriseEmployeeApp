...
namespace EmployeeManagement.Service
{
    public class PagingInfo
    {
        ...
        public void PageEntities()
        {
            ...
            //{
            //    details.Add("The item count was not provided.");
            //}

            //if (!pageSize.HasValue)
            //{
            //    details.Add("The page size was not provided.");
            //}

            //if (!pageNumber.HasValue)
            //{
            //    details.Add("The current page was not provided.");
            //}

            //if (!medianPage.HasValue)
            //{
            //    details.Add("The median page was not provided.");
            //}

            //if (details.Count > 0)
            //{
            //    throw new Exception("Insufficient information was provided to page items.", details);
            //}
